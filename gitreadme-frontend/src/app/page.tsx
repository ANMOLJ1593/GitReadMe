...
export default function HomePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // ✔ NEW: Always use .env for API URL
      const apiUrl = `${process.env.NEXT_PUBLIC_API_URL}/generate-readme`;
      ...
      setResult(
        `# Error\n\nFailed to generate README. Please check your repository URL and backend server.\n\n**Error:** ${
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            {/* ✔ UPDATED: GitReadme Branding */}
            <h1 className="text-3xl font-bold text-stone-900">GitReadme</h1>
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-stone-900 mb-6 leading-tight">
            ...
            <span className="text-stone-600">clear documentation.</span>
          </h2>

          <p className="text-lg text-stone-600 mb-12 max-w-2xl mx-auto">
            GitReadme helps you convert your GitHub repositories into
            professional, structured documentation using AI.
          </p>
        </div>
              ...
              <CardContent className="p-8">
                ...
                <div className="mt-8 pt-6 border-t border-stone-200">
                  <p className="text-sm text-stone-500 text-center mb-4">
                    Try GitReadme with these repositories:
                  </p>

                  <div className="flex flex-wrap gap-2 justify-center">
                    {["facebook/react", "microsoft/vscode", "vercel/next.js"].map(
                      (repo) => (
                        <Button
                          key={repo}
                          variant="outline"
